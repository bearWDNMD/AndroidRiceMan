    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId()==R.id.fav)
        {
            if (rice.getFlag()==0)
            {
                ...
                rice.setFlag(1);
                Util.updateFlag_rice(rice.getFlag(),rice.getId(),ArticleDetailActivity.this);
                SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");// HH:mm:ss
                Date date = new Date(System.currentTimeMillis());
                Util.insert_Favs(rice.getName(),String.valueOf(rice.getId()),simpleDateFormat.format(date),0,ArticleDetailActivity.this);
            }
            else {
                ...
                Util.del_Favs(String.valueOf(rice.getId()),ArticleDetailActivity.this);
            }
        }
