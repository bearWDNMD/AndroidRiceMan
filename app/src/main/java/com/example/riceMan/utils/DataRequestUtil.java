...
public class DataRequestUtil {
        public static void getNewsData(Context context) {//新闻
    ...
    public static void getKnowData(Context context) {//知道
        ArrayList<News> newsArrayList = new ArrayList<>();
        try {
    ...
    public static void getConsultData(Context context) {//咨询
        ArrayList<News> newsArrayList = new ArrayList<>();
        try {
    ...
    public static void getRiceData(Context context) {//经营
